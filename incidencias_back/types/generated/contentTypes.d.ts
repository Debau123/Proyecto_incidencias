...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    rol: Attribute.Enumeration<['usuario', 'tecnico', 'administrador']>;
    incidencias: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::incidencia.incidencia'
    >;
    dispositivos: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiComponenteComponente extends Schema.CollectionType {
  ...
  attributes: {
    tipo_componente: Attribute.Enumeration<
      ['Disco_duro', 'Memoria_ram', 'Procesador']
    >;
    descripcion: Attribute.String;
    especificaciones: Attribute.String;
...
export interface ApiDispositivoDispositivo extends Schema.CollectionType {
  ...
  attributes: {
    tipo_dispositivo: Attribute.Enumeration<
      ['Portatil', 'Movil', 'Ordenador', 'Pantalla', 'Sai']
    >;
    marca: Attribute.String;
    numero_serie: Attribute.String;
    modelo: Attribute.String;
    fecha_compra: Attribute.Date;
    fecha_garantia_fin: Attribute.Date;
    estado: Attribute.Enumeration<
      ['operativo', 'averiado', 'mantenimiento', 'fuera de servicio']
    >;
    user: Attribute.Relation<
      'api::dispositivo.dispositivo',
      'manyToOne',
    ...
    incidencias: Attribute.Relation<
      ...
      'api::incidencia.incidencia'
    >;
    componentes: Attribute.Relation<
      'api::dispositivo.dispositivo',
      'oneToMany',
      'api::componente.componente'
    >;
...
export interface ApiIncidenciaIncidencia extends Schema.CollectionType {
...
export interface ApiLicenciaLicencia extends Schema.CollectionType {
  ...
  attributes: {
    clave_licencia: Attribute.String;
    fecha_inicio: Attribute.Date;
    fecha_expiracion: Attribute.Date;
    software: Attribute.Relation<
